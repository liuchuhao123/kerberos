...
class View:
    def __init__(self):
        ...
        self.data_list = ttk.Treeview(self.frame_list, height=8, show='headings', columns=columns)
        # 滚动条
        ...
        self.entry_sno = tk.Entry(self.frame_detail, state='disabled')
        ...
        self.entry_sex = tk.Entry(self.frame_detail, state='disabled')
    ...
    def set_ui(self):
        ...
        # 放置详细内容控件
        self.lab_sno.grid(row=0, column=1, pady=5)
        self.entry_sno.grid(row=0, column=2, pady=5)
        self.lab_name.grid(row=1, column=1, pady=5)
        self.entry_name.grid(row=1, column=2, pady=5)
        self.lab_sex.grid(row=2, column=1, pady=5)
        self.entry_sex.grid(row=2, column=2, pady=5)
        self.lab_college.grid(row=3, column=1, pady=5)
        self.entry_college.grid(row=3, column=2, pady=5)
        self.lab_clazz.grid(row=4, column=1, pady=5)
        self.entry_clazz.grid(row=4, column=2, pady=5)
        self.btn_delete.grid(row=5, column=1, pady=10, ipadx=10)
        self.btn_update.grid(row=5, column=2, pady=10, ipadx=10)
